...
if($_SESSION["assigned_condition"] != 3){
...
<div id="final_msg" class="instr" style="display:none;">
  ...
  <div class="pull-right">
    <button disabled type="submit" id="submit_final_msg">Bitte warten...</button>
  </div>
...
$(function () {
  ...
  function init_final_msg() {
    ...
    setTimeout(function() {
      $('#submit_final_msg').prop("disabled", false); 
      $('#submit_final_msg').html("Weiter");    
    }, 8000);
